...
public class DroneDangerZone {
    ...
    // Constructor
    public DroneDangerZone(double lon, double lat, boolean visibility, GoogleMap map){
        this.lat = lat;
        this.lon = lon;
        ...
        this.circle = this.map.addCircle(new CircleOptions()
                ...
                .zIndex(10)
                .strokeWidth(5)
                .strokeColor(Color.argb(127, 0, 0, 204))
                .fillColor(Color.argb(127, 0, 0, 204))
