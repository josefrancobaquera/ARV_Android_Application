...
public class HumanHiddenObject {

    /* List of members. Each HumanHiddenObject instance will have these members. */
    private double lat;
    private double lon;
    ...
    // Constructor
    public HumanHiddenObject(double lon, double lat, boolean visibility, GoogleMap map, Context context){
        this.lat = lat;
        this.lon = lon;
        ...
        Bitmap bmap1 = BitmapFactory.decodeResource(this.context.getResources(), R.drawable.human_hidden_object_flag);
